...
SENSOR_TYPES = {
    'air_temperature_cal': ['Air Temp', '°C', 'mdi:thermometer'],
    'soil_temperature': ['Temperature', '°C', 'mdi:thermometer'],
    # 'light': ['Light intensity computed', 'lx', 'mdi:white-balance-sunny'],
    ...
    # 'moisture': ['Moisture_live', '%', 'mdi:water-percent'],
...
async def async_setup_platform(hass, config, async_add_entities,
    ...
    _LOGGER.debug('ParrotPot is using %s backend.', backend.__name__)
